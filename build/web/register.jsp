...
return false;
  ...
  else if(document.getElementById("domain").value=="" || !document.getElementById("domain").value.match(usecase))
  {
  alert("domain Must Not be Empty");
  //document.form1.prof.focus();
  return false;
  }
  
    else if(!document.getElementById("domain").value.match(usecase))
  {
  alert("Doesnot fill with special characters..");
  //document.form1.prof.focus();
  return false;
            ...
            <div align="center" class="tablereg">
                  <table width="384" height="234" border="0" >
                    <tbody>
                        ...
                        <tr class="tr1">
                        <td height="42" class="auto-style1"><span class="style4">Full name </span></td>
                        <td><label>
                          <input name="fullname" type="text" id="full name" />
                        </label></td> </tr>
                         <tr class="tr1">
                      <td height="42" class="auto-style3"><span class="style4">Username</span></td>
                        <td><label>
