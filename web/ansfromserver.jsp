...
Friends Suggestions       </a>
  ...
  <div style="background-color: #d7d9db">
      ...
      <div class="div6-1" >  
        <h2 align="center" style="padding-top:30px;">Analysis Social Roles</h2>
        <form id="form1" name="form1" method="post" action="">
          <div align="center">
              <table width="100%"  align="center">
              
              <tr >
                <td height="60" align="center" class="style18 style1 style19">Answers from Server </td>
              </tr>
              <tr >
                <td height="106" align="center" class="style18 style1 style19"><textarea name="textarea2" cols="60" rows="5"><%=session.getAttribute("ques")%></textarea></td>
              </tr>
              <tr >
                <td height="97" align="center" class="style18 style1 style19"><p>&nbsp;</p>
                <p>
                    <label style="background-color:white; padding:30px 80px 30px 80px;"><span style="color:black;"><%=session.getAttribute("ans")%></span></label>
                </p></td>
              </tr>
            </table>
          </div>
