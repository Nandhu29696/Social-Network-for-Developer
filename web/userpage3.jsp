  ...
  <div class="body" >
        ...
        <h2 align="center"><a href="index.html">Analyse Social Roles</a></h2>
          ...
          <div align="center">
            <table width="100%"  align="center" style="border:1px solid #000000;">
              ...
              <tr bgcolor="#626D1D">
                <td height="42" colspan="7" align="center" bgcolor="#626D1D" class="style18 style1 style19"> Posted Questions with Answers </td>
              </tr>
              <tr>
                <td colspan="7" align="center" height="10"></td>
              </tr>
	...
	if(request.getAttribute("userList2")!=null && request.getAttribute("userList2")!="")
	{
		...
		while(itr4.hasNext())
		{
			...
			String quesq = viewList4.get(1).toString();
			String user = viewList4.get(3).toString();
			String domain = viewList4.get(4).toString();
			...
			while(viewItr4.hasNext())
			{
				...
				<td><input name="ratings" type="text" id="ratings" size="5" /></td>
				<td><input name="fun" type="text" id="fun" size="5" />
			    <label>			    </label></td>
				<td><input name="user" type="text" id="user" style="visibility:hidden" value="<%=user%>" size="3" />
				  <input type="submit" name="Submit4" value="Submit" />
				  <label>
				  <input name="quesq" style="visibility:hidden" type="text" id="quesq" value="<%=quesq%>" size="3" />
				  </label>
<input name="dom" type="text" id="dom" style="visibility:hidden" value="<%=dom%>" size="3" /></td>
	...
	%>
            ...
            <h2 class="style22">Ratings updated successfully.... </h2>
          </div>
        ...
        <table width="384" height="186" border="0" bordercolor="#666666">
          <tbody>
            <tr>
              <td height="52" colspan="2" bgcolor="#626D1D"><div align="center"><span class="style21 style19">&lt;&lt;Place to Post Questions &gt;&gt;</span></div></td>
            </tr>
            <tr>
