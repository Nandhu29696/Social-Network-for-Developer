...
Friends Suggestions       </a>
  ...
  <div style="background-color: #d7d9db">
      ...
      <div class="div6-1" >  
        ...
        <form id="form1" name="form1" method="post" action="AnsfromDB">
          <div align="center">
            <table width="100%"  align="center" style="border:1px solid #000000;">
              <tr>
                <td width="1166" height="10" align="center"></td>
              </tr>
              <tr bgcolor="#626D1D">
                <td height="60" align="center" class="style18 style1 style19">Get Answers from Server </td>
              </tr>
              <tr bgcolor="#626D1D">
                <td height="88" align="center" class="style18 style1 style19"><textarea name="ques" cols="50" rows="5" id="ques"></textarea></td>
              </tr>
              <tr bgcolor="#626D1D">
                <td height="97" align="center" class="style18 style1 style19"><p>&nbsp;</p>
                <p>
                  <input type="submit" name="Submit" value="Get answer from Database Server" />
                </p></td>
              </tr>
