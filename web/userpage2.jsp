...
Friends Suggestions       </a>
	...
	if(!user.equals(user55))
	{
		...
		%>
                ...
                <td><input name="user" type="text" id="user" style="visibility:hidden" value="<%=user%>" size="3" />
                    <input name="answer" type="text" id="answer" style="visibility:hidden" value="<%=answer%>" size="3" />
                    <%
	...
	%>
            ...
            <h2 class="style22" style="font-size:18px; color: green; font-style: italic;">Ratings updated successfully....</h2>
        </div>
	...
	if(request.getAttribute("userList")!=null && request.getAttribute("userList")!="")
	{
		...
		while(itr.hasNext())
		{
          ...
          <tr style="background-color:<%=bgcolor%>;">
            ...
            <td><label>
                <form id="form1" method="post" action="Following">
